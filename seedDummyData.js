...
//  ★ 여기만 채우세요
// ════════════════════════════════════════════════════════════════════
const STORAGE_BUCKET = "meety-b6e17.firebasestorage.app"; // e.g. "myapp-12345.appspot.com"
 ...
 * @param {string} localPath  - 업로드할 파일의 로컬 절대/상대 경로
 * @param {string} destination - Storage 내 저장 경로 (예: "teams/team-001/profile.png")
...
async function uploadAllImages() {
  // 팀 대표사진 URL map:  teamId → URL
  const teamImageUrls = {};
  // 멤버 프로필 URL map:  userId → URL
